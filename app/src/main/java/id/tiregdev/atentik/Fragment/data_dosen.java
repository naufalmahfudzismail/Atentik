...
import id.tiregdev.atentik.Adapter.adapter_dialog_dosen;
...
public class data_dosen extends Fragment {
    ...
    adapter_dialog_dosen rcAdapter;
    ...
    public void setupAdaptermhsw_dosen(){
        ...
        Call<List<object_mhsw_dosen>> call = client.dataDosen("Bearer " + tokens);
        call.enqueue(new Callback<List<object_mhsw_dosen>>() {
            ...
            public void onResponse(Call<List<object_mhsw_dosen>> call, Response<List<object_mhsw_dosen>> response) {
                if(response.isSuccessful())
                {
                    ...
                    rcAdapter = new adapter_dialog_dosen(getContext(), dosen);
