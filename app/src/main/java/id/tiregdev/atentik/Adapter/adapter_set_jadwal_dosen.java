...
public class adapter_set_jadwal_dosen extends RecyclerView.Adapter<adapter_set_jadwal_dosen.holder_set_jadwal> {
    ...
    RadioButton dosenTelat;

    public adapter_set_jadwal_dosen(Context context, List<object_set_jadwal_masuk> itemList){
        this.itemList = itemList;
        this.context = context;
    }

    @Override
    public adapter_set_jadwal_dosen.holder_set_jadwal onCreateViewHolder(ViewGroup parent, int viewType){
        final View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_set_jadwal,null);
        adapter_set_jadwal_dosen.holder_set_jadwal hn = new adapter_set_jadwal_dosen.holder_set_jadwal(layoutView);
        ...
        cv = layoutView.findViewById(R.id.cv);
        cv.setBackgroundColor(ContextCompat.getColor(context, R.color.bgCV));

        namaMatkul = layoutView.findViewById(R.id.namaMatkul);
        namaMatkul.setTextColor(ContextCompat.getColor(context, R.color.putih));

        namaDosen = layoutView.findViewById(R.id.namaDosen);
        namaDosen.setTextColor(ContextCompat.getColor(context, R.color.putih));

        namaTxt = layoutView.findViewById(R.id.namaTxt);
        namaTxt.setTextColor(ContextCompat.getColor(context, R.color.putih));

        namaUpdate = layoutView.findViewById(R.id.namaUpdate);
        namaUpdate.setTextColor(ContextCompat.getColor(context, R.color.toska));

        waktuUpdate = layoutView.findViewById(R.id.waktuUpdate);
        waktuUpdate.setTextColor(ContextCompat.getColor(context, R.color.toska));

//        dosenTelat.setTextColor(ContextCompat.getColor(context, R.color.putih));

        dosenTdkMasuk = layoutView.findViewById(R.id.dosenTidakMasuk);
        dosenTdkMasuk.setTextColor(ContextCompat.getColor(context, R.color.putih));

        dosenTdkMasukMhswMasuk = layoutView.findViewById(R.id.dosenTidakMasukMhswMasuk);
        dosenTdkMasukMhswMasuk.setTextColor(ContextCompat.getColor(context, R.color.putih));

        submit = layoutView.findViewById(R.id.submit);
        submit.setBackgroundResource(R.drawable.bg_button_dark);
        return hn;
    }

    @Override
    public void onBindViewHolder(adapter_set_jadwal_dosen.holder_set_jadwal holder, int position) {
